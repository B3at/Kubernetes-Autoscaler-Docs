...
- [Kubernetes Event Driven Autoscaler (KEDA)](https://github.com/kedacore/keda)
...
- [VPA in Amazon EKS](https://docs.aws.amazon.com/eks/latest/userguide/vertical-pod-autoscaler.html)
- [HPA in Amazon EKS](https://docs.aws.amazon.com/eks/latest/userguide/horizontal-pod-autoscaler.html)
